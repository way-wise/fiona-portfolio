...
// Footer Component
?>
<footer class="tj-footer-area" data-bg-color="#140c1c" style="background-color: rgb(20, 12, 28);">
  <div class="container">
    <div class="row">
      <div class="col text-center">
        ...
        <div class="copy-text">
          <p>© 2025 All Rights Reserved by <a href="https://themejunction.net/" target="_blank">ThemeJunction</a></p>
        </div>
      </div>
    </div>
  </div>
